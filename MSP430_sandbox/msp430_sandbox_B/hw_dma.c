...
void dma_init_spi_rx(volatile unsigned char *rx_buffer)
{
    ...
    __data20_write_long((uintptr_t) &DMA0SA, (uintptr_t)&UCB0RXBUF);    // Source single address
...
void dma_init_spi_tx(volatile unsigned char *tx_buffer)
{
    ...
    __data20_write_long((uintptr_t) &DMA1DA, (uintptr_t)&UCB0TXBUF);    // Destination single address
